                    ...
                    <div className="space-y-6">
                        ...
                        <div className="pt-6">
                                <p className="text-sm text-gray-400">
                                    © {currentYear} Your Company Name.<br />
                                    All rights reserved.
                                </p>
                        ...
                        <div>
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start">
                                    <svg className="w-5 h-5 text-gray-400 mr-3 mt-1" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
